...
class Episode:
    ...
    def __post_init__(self):
        ...
        if self.ends.sum() > 0:
            ...
            self.actions_continuous = self.actions_continuous[:idx_end]
    ...
    def merge(self, other: Episode) -> Episode:
        return Episode(
            ...
            torch.cat((self.actions_continuous, other.actions_continuous), dim=0),
    ...
    def segment(self, start: int, stop: int, should_pad: bool = False) -> Episode:
        ...
        segment = Episode(
            ...
            self.actions_continuous[start:stop],
